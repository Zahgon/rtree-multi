...
public final class RTree<T, S extends Geometry> {
     ...
     */
    public <R extends Geometry> Iterable<Entry<T, S>> search(final R g, final BiPredicate<? super S, ? super R> intersects) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <R extends Geometry> Iterable<Entry<T, S>> search(final R g, final double maxDistance, BiFunction<? super S, ? super R, Double> distance) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
